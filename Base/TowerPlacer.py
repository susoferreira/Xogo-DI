...
class TowerPlacer():
    ...
    def place_tower(self,tower):
        ...
        self.sub = var.mouse_handler.subscribe(None,self.move_tower_to_mouse,mode=pygame.MOUSEMOTION,button=None) # cada vez que se mueva el ratón mover la torre al ratón
